      ...
      <div className="container">
        ...
        <div className='documentation-group'>
          <div className="documentation-group-text">
            ...
            <p>
              IVL Svenska Miljöinstitutet har i uppdraget för Järfälla kommun, i samarbete med kommunen och
              företaget Flexiclean, installerat och utvärderat brunnsfilter med tallbark och flis för att minska
              spridningen av mikroplast och andra föroreningar i dagvatten från konstgräsplaner och trafikytor.
            </p>
            <div>
              <span>Ladda ner hela uppsatsen</span>
              <a href="https://www.flexiclean.eu/Homepage/Download-File/f/1316759/h/5cf3ec391113acf2430b2df9067210c1/C638+Installation+av+filter%2C+provtagning+och+analys+av+dagvatten"> här.</a>
            </div>
          </div>
        ...
        <div className='documentation-group'>
          <div className="documentation-group-text">
            <h4>
              Components for area-efficient
              stormwater treatment systems, Luleå Tekniska universitet, 2021
            </h4>
            <p>
            ...
            <div>
              <span>Ladda ner hela uppsatsen</span>
              <a href="https://www.flexiclean.eu/Homepage/Download-File/f/1299629/h/f884472b5a419dc81ddf19259af63d50/FULLTEXT03_LTU%2BBark"> här.</a>
            </div>
          </div>
        ...
        <div className='documentation-group'>
          <div className="documentation-group-text">
            <h4>
              Utvärdering av filtermaterial för att avlägsna lösta organiska föroreningar i dagvatten, Chalmers tekniska högskola, 2019
            </h4>
            <p>
            ...
            <div>
              <span>Ladda ner hela uppsatsen</span>
              <a href="https://www.flexiclean.eu/Homepage/Download-File/f/1227509/h/8e4bfe411ae1f0094e4f171ab6c4f8dd/vatten_2_2019_205%2B216_Chalmers"> här.</a>
            </div>
          </div>
          <img src="https://www.cesaer.org/img-cache/25a04vwvn7-chalmers_-v.43ad610a.png" width='100px' height='auto' alt="" />
        </div>

        <div className='documentation-group'>
          <div className="documentation-group-text">
            <h4>
              Rekommendationer för anläggning av konstgräsplaner, Svenska Fotbollsförbundet, april 2017
            </h4>
            <p>
            ...
            <div>
              <span>Ladda ner hela uppsatsen</span>
              <a href="https://www.flexiclean.eu/Homepage/Download-File/f/977084/h/9022f31754a17c3d2c878f016afa453d/17+Rekommendationer+KG%2Banl%C3%A4ggning+%2B+Reviderad+version+2017%2B04%2B10+%28webb%29"> här.</a>
            </div>
          </div>
          <img src="https://www.svenskfotboll.se/48fcb2/globalassets/svff/bilderblock/logotyper/distriktsemblem/svff.svg" width='100px' height='auto' alt="" />
        </div>

        <div className='documentation-group'>
          <div className="documentation-group-text">
            <h4>
              Dagvatten utvärdering filter, Provtagning Dagvatten Göteborg, december 2016
            </h4>
            <p>
            ...
            <div>
              <span>Ladda ner hela uppsatsen</span>
              <a href="https://www.flexiclean.eu/Homepage/Download-File/f/977087/h/d0a262b908fc8d8bfec05965625f7484/12803415+KV+Dagvatten+provtagning+Sahlgrenska+v3+17_01_04"> här.</a>
            </div>
          </div>
        ...
        <div className='documentation-group'>
          <div className="documentation-group-text">
            <h4>
              Utbyte av filterkassetter, WSP, 2015-2016.
            </h4>
            <p>
            ...
            <div>
              <span>Ladda ner hela uppsatsen</span>
              <a href="https://www.flexiclean.eu/Homepage/Download-File/f/977205/h/cde5c898e3fb8217ba61f91430955a2d/WSP+prover+V%C3%A4ster%C3%A5s+2016_j%C3%A4mf%C3%B6relse"> här.</a>
            </div>
          </div>
        ...
        <div className='documentation-group'>
          <div className="documentation-group-text">
            <h4>
              ...
              bark and blast furnace slag by using batch experiments, Mälardagens högskola, 2008
            </h4>
            <p>
            ...
            <div>
              <span>Ladda ner hela uppsatsen</span>
              <a href="https://www.flexiclean.eu/Homepage/Download-File/f/977206/h/d3a971e1c05149518fa3300a8663b0ac/Nehrenheim_Gustafsson_2008"> här.</a>
            </div>
          </div>
        ...
        <div className='documentation-group'>
          <div className="documentation-group-text">
            ...
            <div>
              <span>Ladda ner hela uppsatsen</span>
              <a href="https://www.flexiclean.eu/Homepage/Download-File/f/977288/h/9d70a85192da6c23948c70d0fea90957/SP_fl%C3%B6destest"> här.</a>
            </div>
          </div>
        ...
        <div className='documentation-group'>
          <div className="documentation-group-text">
            <h4>
              PM - Kontrollprovtagning dagvattenrening, Munktellstaden Eskilstuna, Structor Miljöteknik, 2009
            </h4>
            <p>
            ...
            <div>
              <span>Ladda ner hela uppsatsen</span>
              <a href="https://www.flexiclean.eu/Homepage/Download-File/f/977292/h/7360ae7969e44107d7c30eec60c31b70/PM+%2B+Kontrollprov+2+structor"> här.</a>
            </div>
          </div>
