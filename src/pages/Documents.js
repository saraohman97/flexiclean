...
const Documents = () => {
  return (
    <section className='container mx-auto mt-40 px-20 mb-20 max-md:px-2'>
      <div className='flex flex-col gap-4'>
        <h1 className='text-4xl text-center'>Dokumentcenter</h1>
        <p className='text-center w-4/6 self-center mb-10 max-md:w-full'>Här publicerar vi fortlöpande tester utförda på FlexiClean. Redan för 14 år sedan blev vi tipsade om att använda bark som filtermaterial. De senare åren av forskning visar att vi valt rätt. Ladda gärna ned rapporterna nedan.</p>
      ...
      <div className='flex flex-col gap-10'>
        <div className="flex justify-between shadow-lg p-4 rounded hover:scale-105 gap-10 max-md:flex-col-reverse items-center">
          <div className='flex-1'>
            ...
            <a href="https://www.flexiclean.eu/Homepage/Download-File/f/1316759/h/5cf3ec391113acf2430b2df9067210c1/C638+Installation+av+filter%2C+provtagning+och+analys+av+dagvatten">
              <button className='btn btn-gray mt-6'>Ladda ner hela uppsatsen</button>
            </a>
          </div>
          <img className='w-60 object-contain'src="https://dst15js82dk7j.cloudfront.net/252829/97260241-tJLrg.jpg" alt="Installation av filter, provtagning och analys av dagvatten. IVL, november 2021" />
        </div>
        ...
        <div className="flex justify-between shadow-lg p-4 rounded hover:scale-105 gap-10 max-md:flex-col-reverse items-center">
          ...
          <img className='w-60 object-contain' src="https://dst15js82dk7j.cloudfront.net/252829/97260234-B1XER.png" alt="Components for area-efficient stormwater treatment systems, Luleå Tekniska universitet, 2021" />
        </div>
        ...
        <div className="flex justify-between shadow-lg p-4 rounded hover:scale-105 gap-10 max-md:flex-col-reverse items-center">
          <div className='flex-1'>
            ...
            <img className='w-60 object-contain' src="https://www.cesaer.org/img-cache/25a04vwvn7-chalmers_-v.43ad610a.png" alt="Utvärdering av filtermaterial för att avlägsna lösta organiska föroreningar i dagvatten, Chalmers tekniska högskola, 2019" />
        </div>
        ...
        <div className="flex justify-between shadow-lg p-4 rounded hover:scale-105 gap-10 max-md:flex-col-reverse items-center">
          <div className='flex-1'>
            ...
            <img className='w-60 object-contain' src="https://www.svenskfotboll.se/48fcb2/globalassets/svff/bilderblock/logotyper/distriktsemblem/svff.svg" alt="Rekommendationer för anläggning av konstgräsplaner, Svenska Fotbollsförbundet, april 2017" />
        </div>
        ...
        <div className="flex justify-between shadow-lg p-4 rounded hover:scale-105 gap-10 max-md:flex-col-reverse items-center">
          <div className='flex-1'>
            ...
            <img className='w-60 object-contain' src="https://dst15js82dk7j.cloudfront.net/252829/71095419-sBi5t.png" alt="Dagvatten utvärdering filter, Provtagning Dagvatten Göteborg, december 2016" />
        </div>
        ...
        <div className="flex justify-between shadow-lg p-4 rounded hover:scale-105 gap-10 max-md:flex-col-reverse items-center">
          ...
          <img className='w-60 object-contain' src="https://h24-original.s3.amazonaws.com/252829/24431606-BnUYw.png" alt="Utbyte av filterkassetter, WSP, 2015-2016" />
        </div>
        ...
        <div className="flex justify-between shadow-lg p-4 rounded hover:scale-105 gap-10 max-md:flex-col-reverse items-center">
          <div className='flex-1'>
            ...
            <img className='w-60 object-contain' src="https://h24-original.s3.amazonaws.com/252829/24431623-FE0kl.png" alt="Kinetic sorption modelling of Cu, Ni, Zn, Pb and Cr ions to pine bark and blast furnace slag by using batch experiments, Mälardagens högskola, 2008" />
        </div>
        ...
        <div className="flex justify-between shadow-lg p-4 rounded hover:scale-105 gap-10 max-md:flex-col-reverse items-center">
          ...
          <img className='w-60 object-contain' src="https://dst15js82dk7j.cloudfront.net/252829/71109976-Te4hm.png" alt="Provning av filter till dagvattenbrunn, SP Sveriges Provnings- och Forskningsinstitut AB, 2004" />
        </div>
        ...
        <div className="flex justify-between shadow-lg p-4 rounded hover:scale-105 gap-10 max-md:flex-col-reverse items-center">
          <div className='flex-1'>
            ...
            <img className='w-60 object-contain' src="https://dst15js82dk7j.cloudfront.net/252829/71110015-0BbhN.png" alt="PM - Kontrollprovtagning dagvattenrening, Munktellstaden Eskilstuna, Structor Miljöteknik, 2009" />
        </div>
